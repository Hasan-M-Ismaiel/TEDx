                                                                    ...
                                                                    <div class="row border-bottom p-4 rounded mx-3 my-2 ">
                                                                        ...
                                                                        <div class="col-md-6 my-2">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <input type="texts" name="phone_number" class="form-control" id="phone_number" placeholder="add phone number" value="{{ old('phone_number') }}">
                                                                            </div>
                                                                        </div>
                                                                        <!-- //profession -->
                                                                        <div class="col-md-6 my-2">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <input type="text" name="profession" class="form-control" id="profession" placeholder="add profession" value="{{ old('profession') }}">
                                                                            </div>
                                                                        </div>
                                                                        <!-- //bio -->
                                                                        <div class="col-md-6 my-2">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <input type="textarea" name="bio" class="form-control" id="bio" placeholder="add Bio" rows="4" cols="50" value="{{ old('bio') }}">
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        <div class="col-md-6 my-2">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <input type="textarea" name="talk_idea" class="form-control" id="talk_idea" placeholder="add talk idea" rows="4" cols="50" value="{{ old('talk_idea') }}">
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        <div class="col-md-6 my-2">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <input type="textarea" name="talk_idea_outline" class="form-control" id="talk_idea_outline" placeholder="add talk idea outline" rows="4" cols="50" value="{{ old('talk_idea_outline') }}">
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        <div class="col-md-6 my-2">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <input type="textarea" name="audience_takeaway_message" class="form-control" id="audience_takeaway_message" placeholder="add audience takeaway message" rows="4" cols="50" talk_idea_outline value="{{ old('audience_takeaway_message') }}">
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        <div class="col-md-6 my-2">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <input type="textarea" name="question1" class="form-control" id="question1" placeholder="add answer" rows="4" cols="50" value="{{ old('question1') }}">
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        <div class="col-md-6 my-2">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <input type="textarea" name="question2" class="form-control" id="question2" placeholder="add answer" rows="4" cols="50" value="{{ old('question2') }}">
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        <div class="col-md-6 my-2">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <input type="textarea" name="question3" class="form-control" id="question3" placeholder="add answer" rows="4" cols="50" value="{{ old('question3') }}">
                                                                            </div>
                                                                        </div>
