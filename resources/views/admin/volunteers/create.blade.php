                                                                    ...
                                                                    <div class="row border-bottom p-4 rounded mx-3 my-2 ">
                                                                        ...
                                                                        <div class="col-md-6 my-2">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <input type="texts" name="first_name" class="form-control" id="first_name" placeholder="add the first name" value="{{ old('$volunteer->first_name') }}">
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        <div class="col-md-6 my-2">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <input type="texts" name="last_name" class="form-control" id="last_name" placeholder="add the last name" value="{{ old('$volunteer->last_name') }}">
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        <div class="col-md-6 my-2">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <input type="email" name="email" class="form-control" id="email" placeholder="add the email" value="{{ old('$volunteer->email') }}">
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        <div class="col-md-6 my-2">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <input type="texts" name="phone_number" class="form-control" id="phone_number" placeholder="add the phone number" value="{{ old('$volunteer->phone_number') }}">
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        <div class="col-md-6 my-2">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <textarea name="question1" class="form-control" id="question1" placeholder="add answer" rows="4" cols="50" value="{{ old('question1') }}"></textarea>
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        <div class="col-md-6 my-2">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <textarea name="question2" class="form-control" id="question2" placeholder="add answer" rows="4" cols="50" value="{{ old('question2') }}"></textarea>
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        <div class="col-md-6 my-2">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <textarea name="question3" class="form-control" id="question3" placeholder="add answer" rows="4" cols="50" value="{{ old('question3') }}"></textarea>
                                                                            </div>
                                                                        </div>
