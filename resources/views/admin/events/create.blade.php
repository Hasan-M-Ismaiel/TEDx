                                ...
                                <form id="msform" action='{{ route("admin.events.store") }}' method="POST">
                                    ...
                                    <fieldset>
                                        <div class="form-card">
                                            ...
                                            <div class="mt-3">
                                                ...
                                                <input id="date" type="date" placeholder="Event's date..." name="date" value="{{ old('date') }}" />

                                                <!--location-->
                                                <label class="fieldlabels" for="location">Location: *</label>
                                                <input id="location" type="text" placeholder="Event's location..." name="location" value="{{ old('location') }}" />
                                                ...
                                                <div class="row p-4 rounded mx-3 my-2 ">
                                                    ...
                                                    <div class="col-md-6 my-2">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-11">
                                                                <input type="text" class="form-control" name="linkedin" id="linkedin" aria-describedby="linkedin_addon3" placeholder="add the linkedin account" value="{{ old('linedin') }}">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <!--twitter account-->
                                                    <div class="col-md-6 my-2">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-11">
                                                                <input type="text" class="form-control" name="twitter" id="twitter" aria-describedby="twitter_addon3" placeholder="add the twitter account" value="{{ old('twitter') }}">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <!--instagram account-->
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-11">
                                                                <input type="text" class="form-control" name="phone" id="website" aria-describedby="website_addon3" placeholder="add phone number" value="{{ old('phone') }}">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                    ...
                                    <fieldset>
                                        <div class="form-card">
                                            ...
                                            <div class="row">
                                                <div class="col-7">
                                                    <h2 class="fs-title">Pictures for event:</h2>
                                                </div>
                                                <div class="col-5">
