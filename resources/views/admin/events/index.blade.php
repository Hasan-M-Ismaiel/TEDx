          ...
          <div class="container-fluid my-3  ">
            <div class="row justify-content-center">
              <div class="card-create-project pt-4 my-3 mx-5 px-5">
                ...
                <p id="pcreateProject">dashboard to manage all created Events</p>
                <a type="button" class="rounded" href="{{ route('admin.events.create') }}" style="text-decoration: none;" role="button">
                  <div class="action-main-create-button px-5 text-center py-3 rounded">Create New Event</div>
                </a>
              </div>
            </div>
          </div>
        ...
        <div class="col position-relative">
          <div class="col mx-auto position-absolute bottom-0 end-0">
            <div class="input-group mb-3 me-3">
              ...
              <a class="btn btn-primary me-2" href="{{ route('admin.exportEvents') }}" role="button">export as Excel</a>
            </div>
          </div>
        </div>
      </div>
...
<div class="card text-center mt-4 p-4">
  <h5> <span class="badge m-1" style="background: #673AB7;">There is no events in the system</span> </h5>
</div>
@endif
</div>
</div>
