            ...
            <div class="row justify-content-center">
                <div class="card-create-project pt-4 my-3 mx-5 px-5">
                  ...
                  <p id="pcreateProject">dashboard to manage all created Events</p>
                    <a type="button" class="rounded" href="{{ route('admin.events.create') }}" style="text-decoration: none;" role="button"><div  class="action-main-create-button px-5 text-center py-3 rounded">Create New Event</div></a>
                </div>
            </div>
        </div>
      </div>
