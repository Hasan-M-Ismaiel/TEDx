                                    ...
                                    <div class="col">
                                        <div class="card p-3">
                                            <div class="card-body cardParentEditClass">
                                                ...
                                                <img src="{{ $event->getFirstMediaUrl('events') }}" class="rounded float-start me-2" alt="event" width="200" height="200">
                                                @else
                                                <img src="{{ asset('assets/images/avatar.png') }}" class="rounded float-start me-2" alt="event" width="200" height="200">
                                                @endif
                                                <!--green | red -->
                                                ...
                                                <div class="progress blue">
                                                    <div class="progress-bar" style="width:{{$event->remainingTime()}}%; background:#1a4966;">
                                                        <div class="progress-value">{{$event->remaining_time()}}</div>
                                                    </div>
                                                </div>
                                                                        ...
                                                                        <li class="list-inline-item">
                                                                            ...
                                                                            <a href="{{ route('admin.speakers.show', $speaker->id) }}" style="text-decoration: none;" class="position-relative py-2 px-3" data-bs-toggle="tooltip" data-bs-placement="top" title="{{$speaker->first_name}}">
                                                                                <div class="avatar avatar-md">
                                                                                    ...
                                                                                    <img src="{{ $speaker->getFirstMediaUrl('speakers') }}" class="avatar-img border border-success shadow mb-1" alt="speaker">
                                                                                    @else
                                                                                    <img src="{{ asset('assets/images/avatar.png') }}" class="avatar-img border border-success shadow mb-1" alt="speaker">
                                                                                    @endif
                                                                                </div>
                                                                            </a>
                                                                            @endforeach
                                                                        ...
                                                                        <li class="list-inline-item">
                                                                            ...
                                                                            <a href="{{ route('admin.sponsers.show', $sponser->id) }}" style="text-decoration: none;" class="position-relative py-2 px-3" data-bs-toggle="tooltip" data-bs-placement="top" title="{{$sponser->first_name}}">
                                                                                <div class="avatar avatar-md">
                                                                                    ...
                                                                                    <img src="{{ $sponser->getFirstMediaUrl('sponsers') }}" class="avatar-img border border-success shadow mb-1" alt="sponser">
                                                                                    @else
                                                                                    <img src="{{ asset('assets/images/avatar.png') }}" class="avatar-img border border-success shadow mb-1" alt="sponser">
                                                                                    @endif
                                                                                </div>
                                                                            </a>
                                                                            @endforeach
                                                                        ...
                                                                        <li class="list-inline-item">
                                                                            ...
                                                                            <a href="{{ route('admin.members.show', $member->id) }}" style="text-decoration: none;" class="position-relative py-2 px-3" data-bs-toggle="tooltip" data-bs-placement="top" title="{{$member->first_name}}">
                                                                                <div class="avatar avatar-md">
                                                                                    ...
                                                                                    <img src="{{ $member->getFirstMediaUrl('members') }}" class="avatar-img border border-success shadow mb-1" alt="member">
                                                                                    @else
                                                                                    <img src="{{ asset('assets/images/avatar.png') }}" class="avatar-img border border-success shadow mb-1" alt="member">
                                                                                    @endif
                                                                                </div>
                                                                            </a>
                                                                            @endforeach
                                                                    ...
                                                                    <ul class="list-inline">
                                                                        <li class="list-inline-item">
                                                                            ...
                                                                            <a href="{{ route('admin.volunteers.show', $volunteer->id) }}" style="text-decoration: none;" class="position-relative py-2 px-3" data-bs-toggle="tooltip" data-bs-placement="top" title="{{$volunteer->first_name}}">
                                                                                <div class="avatar avatar-md">
                                                                                    <img src="{{ asset('assets/images/avatar.png') }}" class="avatar-img border border-success shadow mb-1" alt="volunteer">
                                                                                </div>
                                                                            </a>
                                                                            @endforeach
                                                                        </li>
                                                                    ...
                                                                    <ul class="list-inline">
                                                                        <li class="list-inline-item">
                                                                            ...
                                                                            <a href="{{ route('admin.registers.show', $register->id) }}" style="text-decoration: none;" class="position-relative py-2 px-3" data-bs-toggle="tooltip" data-bs-placement="top" title="{{$register->first_name}}">
                                                                                <div class="avatar avatar-md">
                                                                                    <img src="{{ asset('assets/images/avatar.png') }}" class="avatar-img border border-success shadow mb-1" alt="register">
                                                                                </div>
                                                                            </a>
                                                                            @endforeach
                                                                        </li>
