                    ...
                    <div class="container-fluid border my-3  ">
                        <div class="row justify-content-center">
                            <div class="card-create-project pt-4 my-3 mx-5 px-5">
                                <h2 id="heading">Creating event</h2>
                                        ...
                                        <div class="form-card">
                                            ...
                                            <div class="row justify-content-center">
                                                <div class="col-7 text-center">
                                                    ...
                                                    <h5 class="purple-text text-center">Add speakers, sponsers, members, volunteers, registers by click click <a href="{{route('home')}}">here</a>, or go <a href="{{route('admin.events.index')}}">home</a></h5>
                                                </div>
                                            </div>
                                        </div>
                                    </fieldset>
